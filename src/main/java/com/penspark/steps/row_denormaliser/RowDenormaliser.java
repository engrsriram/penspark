package com.penspark.steps.row_denormaliser;
...
public class RowDenormaliser extends RowDenormaliserMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(RowDenormaliser.class);
	public RowDenormaliser(Element element) {
		super(element);
