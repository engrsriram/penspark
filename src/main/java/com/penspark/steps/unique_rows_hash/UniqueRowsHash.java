package com.penspark.steps.unique_rows_hash;
...
public class UniqueRowsHash extends UniqueRowsHashMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(UniqueRowsHash.class);
	public UniqueRowsHash(Element element) {
		super(element);
