...
public class ClosureGenerator extends ClosureGeneratorMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(ClosureGenerator.class);
	public ClosureGenerator(Element element) {
		super(element);
