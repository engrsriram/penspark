package com.penspark.steps.xsl_transformation;
...
public class XslTransformation extends XslTransformationMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(XslTransformation.class);
	public XslTransformation(Element element) {
		super(element);
