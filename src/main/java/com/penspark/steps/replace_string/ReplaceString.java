package com.penspark.steps.replace_string;
...
public class ReplaceString extends ReplaceStringMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(ReplaceString.class);
	public ReplaceString(Element element) {
		super(element);
