package com.penspark.steps.row_normaliser;
...
public class RowNormaliser extends RowNormaliserMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(RowNormaliser.class);
	public RowNormaliser(Element element) {
		super(element);
