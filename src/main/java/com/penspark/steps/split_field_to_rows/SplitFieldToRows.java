package com.penspark.steps.split_field_to_rows;
...
public class SplitFieldToRows extends SplitFieldToRowsMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(SplitFieldToRows.class);
	public SplitFieldToRows(Element element) {
		super(element);
