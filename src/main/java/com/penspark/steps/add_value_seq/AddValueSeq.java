package com.penspark.steps.add_value_seq;
...
public class AddValueSeq extends AddValueSeqMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(AddValueSeq.class);
	public AddValueSeq(Element element) {
		super(element);
