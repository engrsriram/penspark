package com.penspark.steps.add_seq;
...
public class AddSeq extends AddSeqMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(AddSeq.class);
	public AddSeq(Element element) {
		super(element);
