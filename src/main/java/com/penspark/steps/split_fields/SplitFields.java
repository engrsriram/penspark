package com.penspark.steps.split_fields;
...
public class SplitFields extends SplitFieldsMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(SplitFields.class);
	public SplitFields(Element element) {
		super(element);
