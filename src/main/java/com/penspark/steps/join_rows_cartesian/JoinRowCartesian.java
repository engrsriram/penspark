package com.penspark.steps.join_rows_cartesian;
...
public class JoinRowCartesian extends JoinRowCartesianMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(JoinRowCartesian.class);
	public JoinRowCartesian(Element element) {
		super(element);
