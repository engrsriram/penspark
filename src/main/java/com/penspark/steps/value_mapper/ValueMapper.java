package com.penspark.steps.value_mapper;
...
public class ValueMapper extends ValueMapperMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(ValueMapper.class);
	public ValueMapper(Element element) {
		super(element);
