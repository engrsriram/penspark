package com.penspark.steps.add_checksum;
...
public class AddCheckSum extends AddCheckSumMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(AddCheckSum.class);
	public AddCheckSum(Element element) {
		super(element);
