package com.penspark.steps.row_flattener;
...
public class RowFlattener extends RowFlattenerMeta implements  StepInterface 
{
	Dataset<Row> Input = null;
	Dataset<Row> Output = null;
	ArrayList<String> oper =  new ArrayList<String>();
	//String[] oper;
	static Logger log = Logger.getLogger(RowFlattener.class);
	public RowFlattener(Element element) {
		super(element);
